...
| SortOrder | [logs.LogEntryQuerySortOrder](log_entry_query_sort_order.md) | ❌       | The sort order of the log entries. `asc` will sort the log entries in chronological order. `desc` will sort the log entries in reverse chronological order. |
