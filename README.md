# SaladCloudSdk Go SDK 0.9.0-alpha.7
...
| [InferenceEndpointList](documentation/models/inference_endpoint_list.md)                           | Represents a page from the collection of inference endpoints.            |
...
| [InferenceEndpointJobEventAction](documentation/models/inference_endpoint_job_event_action.md)     |                                                                          |
